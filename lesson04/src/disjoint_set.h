...
class DisjointSet {
public:
    DisjointSet(long size); // конструктор - создает size элементов, каждый элемент - состоит в своем личном множестве (размера 1)
    ...
    int count_differents(); // говорит сколько сейчас есть разных множеств
